...
export type HelmetQueryVariables = {};


export type HelmetQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description'>> }> };

export type PostsPageQueryVariables = {};


export type PostsPageQuery = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'id'>
        & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'description' | 'date'>>, fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>> }
      ) }> } };
